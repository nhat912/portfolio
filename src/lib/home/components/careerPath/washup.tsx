	...
	return (
		<section>
			...
			<div className="space-y-2 mt-4">
				<p>
					I was involved in improving existing workflows and creating
					new workflows for some of the platform&apos;s features, such
					as:
				</p>
				<ul className="list-outside list-disc container space-y-2">
					<li className="text-wrap">
						Streamlined and shortened the ordering process to
						minimize the number of steps for the user.
					</li>
					<li>
						Developed an insurance sales flow, gathered information
						on insurance packages, adjusted the layout, and added
						basic features to enhance the user experience, drawing
						from negative experiences with other platforms.
					</li>
					<li>
						Enhanced the order reception process for technicians.
					</li>
				</ul>
			</div>
