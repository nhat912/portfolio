...
function FeatureCard({
    ...
    return (
        <Link
            href={href}
            className={cn("col-span-1 shadow-black shadow lg:shadow-lg rounded-lg overflow-hidden p-px", isActive ? 'bg-gradient-to-tr from-secondary to-primary' : 'bg-4b group')}
        >
