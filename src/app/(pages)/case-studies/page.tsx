            ...
            <main className="pb-10 lg:pb-[100px]">
                ...
                <ChildSectionLayout value="Overview" className="container">
                    <div className="space-y-2 lg:space-y-3 mt-4 lg:mt-8">
                        <p>
                            This collection presents two key case studies from different stages of my professional journey.
                        </p>
                        <ul className="list-outside list-disc container space-y-2">
                            ...
                            <li>
                                The second related to VP Bank App UX problems, completed six months ago, showcases my growth, refined skills, and ability to deliver impactful results with more advanced techniques. Both projects reflect my continuous learning and adaptability in evolving professional environments.
                            </li>
                        </ul>
                    </div>
