			...
			<div className="flex items-center justify-center gap-10">
				<div className="w-[209px] h-[421px] relative">
					<Image
						fill
						alt="bogs"
						src="/case-studies/waveb/footer-1.png"
						className=''
					/>
				</div>
				<div className="w-[247px] h-[499px] relative">
					<Image
						fill
						alt="bogs"
						src="/case-studies/waveb/footer-2.png"
						className=''
					/>
				</div>
				<div className="w-[286px] h-[577px] relative">
					<Image
						fill
						alt="bogs"
						src="/case-studies/waveb/footer-3.png"
						className=''
					/>
				</div>
				<div className="w-[247px] h-[499px] relative">
					<Image
						fill
						alt="bogs"
						src="/case-studies/waveb/footer-4.png"
						className=''
					/>
				</div>
				<div className="w-[209px] h-[421px] relative">
					<Image
						fill
						alt="bogs"
						src="/case-studies/waveb/footer-5.png"
						className=''
					/>
				</div>
			</div>
